...
(function(execute) {
	...
	Plugin.prototype = {
		...
		render: function() {
			...
			var name = this.config.name?" name='"+this.config.name+"'":"";
			var id = this.config.id?" id='"+this.config.id+"'":"";
			...
			if(format && format != "") {
				...
				contentStr = '<div class="pick-show"><input type="hidden" value=""'+id+name+' class="pick-area" readonly/><span class="pick-province">请选择省</span><i>/</i><span class="pick-city">请选择市</span><i>/</i><span class="pick-county">请选择县</span><em class="pick-arrow"></em></div><ul class="pick-list"></ul>';
				this.format = "p/c/c"
			}
			if(setFormat) {
				var slash = 0,
				...
				if(setFormat.match("province")) {
					...
					contentStr = '<div class="pick-show"><input type="hidden" value=""'+id+name+' class="pick-area" readonly/>' + strSpan + '<em class="pick-arrow"></em></div><ul class="pick-list"></ul>'
				} else {
					if(slash == 0) {
