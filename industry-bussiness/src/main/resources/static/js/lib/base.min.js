                        ...
                        base.form.validate = function(option) {
                            ...
                            return self.form = option.form ? option.form: null,
                                ...
                                self.init = function() {
                                    ...
                                    0 == $("#errorStyle").length && $("head").append("<style id='errorStyle'>.errorStyle{border:1px solid red;}</style>")
                                },
                                self.scan = function() {
                            ...
                            t.container = e.container ? e.container: null,
                                ...
                                t.createBeehiveItem = function(e, a) {
                                    ...
                                    var r = "<a class='ui-beehive-item-in' val='" + a.id + "' index='" + e + "' href='#'>" +
                                        "<img src='../images/indexImg/"+a.id+".png' style='z-index:55'><div>" +
                                        "<div class='ui-beehive-item-text'><div style='background:"+t.colors[Math.round(Math.random()*24)]+"'>" +a.itemName +          "</div></div></div></a>";
                                    $(n).html(r),
                                        $(t.beehive).append(n),
