...
;(function ($, window, document) {
    ...
    Indicator.prototype = {
        ...
        init: function () {
			...
			ctx.shadowOffsetX = 0;
			ctx.shadowOffsetY = 0;
			ctx.shadowBlur = indOption.shadowRadius;
			ctx.shadowColor = indOption.shadowColor?indOption.shadowColor:"rgba(0,0,0,0.8)";
            //draw a grey circle
        ...
        value: function (val) {
            ...
            //var perVal = val;
            var dispVal = indOption.percentage ? perVal + '%' : this.formatter(val); //formatted value
            ...
            ctx.beginPath();
            ctx.arc(center, center, indOption.radius-indOption.shadowRadius, -(quart), ((circ) * perVal / 100) - quart, false);
            ctx.stroke();
